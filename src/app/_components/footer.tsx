...
export const Footer = () => {
  return (
    <div className=" bg-[#1f1e25] h-auto">
      <div className=" grid grid-cols-2 sm:grid-cols-2 md:grid-cols-5 max-sm:gap-7 p-[30px] md:p-[100px]">
        <div className="flex flex-col gap-2">
          <h1 className="text-2xl text-[#fff] font-[700] uppercase">
            ECHOVOICE
          </h1>
        ...
        <div className="flex flex-col gap-2">
          <h1 className="text-sm md:text-2xl text-[#fff] font-[700] uppercase">
            Product
          </h1>
